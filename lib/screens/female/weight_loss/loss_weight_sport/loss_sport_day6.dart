...
class LossSportDay6 extends StatefulWidget {
  const LossSportDay6({Key? key}) : super(key: key);

  @override
  _LossSportDay6State createState() => _LossSportDay6State();
}

class _LossSportDay6State extends State<LossSportDay6> {
