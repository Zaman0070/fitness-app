...
class LossSportDay9 extends StatefulWidget {
  ...
  @override
  _LossSportDay9State createState() => _LossSportDay9State();
}

class _LossSportDay9State extends State<LossSportDay9> {
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                      top: 20,
                      left: 90,
                      child: Image.asset('assets/loss_sp/loss12.png',height: 23.h,)),
                ],
              ),
            ),
          ],
