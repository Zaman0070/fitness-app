...
class LossSportDay8 extends StatefulWidget {
  const LossSportDay8({Key? key}) : super(key: key);

  @override
  _LossSportDay8State createState() => _LossSportDay8State();
}

class _LossSportDay8State extends State<LossSportDay8> {
