...
class LossSportDay7 extends StatefulWidget {
  ...
  @override
  _LossSportDay7State createState() => _LossSportDay7State();
}

class _LossSportDay7State extends State<LossSportDay7> {
                          ...
                          children: const [
                            ...
                            Directionality(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "قم بالقرفصاء حتى تصبح فخذيك أعلى قليلاً من ركبتيك ، قم بالقيادة ",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
