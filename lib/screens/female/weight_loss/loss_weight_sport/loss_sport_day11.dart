...
class LossSportDay11 extends StatefulWidget {
  ...
  @override
  _LossSportDay11State createState() => _LossSportDay11State();
}

class _LossSportDay11State extends State<LossSportDay11> {
                          ...
                          children: const [
                            ...
                            Directionality(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "تشمل تمارين الإطالة التي يمكن أن تساعد في علاج آلام الركبة الكواد ، وربلة الساق",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
