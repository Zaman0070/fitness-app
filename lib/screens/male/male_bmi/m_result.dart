...
class MaleBmiResult extends StatefulWidget {
  final double result;
  const MaleBmiResult({Key? key, required this.result}) : super(key: key);

  @override
  _MaleBmiResultState createState() => _MaleBmiResultState();
}

class _MaleBmiResultState extends State<MaleBmiResult> {
