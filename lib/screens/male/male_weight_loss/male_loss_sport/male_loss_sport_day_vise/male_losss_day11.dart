...
class MaleLossDay11 extends StatefulWidget {
  ...
  @override
  _MaleLossDay11State createState() => _MaleLossDay11State();
}

class _MaleLossDay11State extends State<MaleLossDay11> {
                          ...
                          children: const [
                            ...
                            Directionality(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "دفع البطن لأسفل نحو الأرض لأنك بعد ذلك تكسر الظهر في الاتجاه الآخر",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
