...
class MaleLossSportDay1 extends StatefulWidget {
  const MaleLossSportDay1({Key? key}) : super(key: key);

  @override
  _MaleLossSportDay1State createState() => _MaleLossSportDay1State();
}

class _MaleLossSportDay1State extends State<MaleLossSportDay1> {
