...
class MaleLossDay2 extends StatefulWidget {
  const MaleLossDay2({Key? key}) : super(key: key);

  @override
  _MaleLossDay2State createState() => _MaleLossDay2State();
}

class _MaleLossDay2State extends State<MaleLossDay2> {
                          ...
                          children: const [
                            ...
                            Directionality(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "استلقِ على ظهرك وساقيك مفرودتين معًا",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
