...
class MaleLossDay4 extends StatefulWidget {
  const MaleLossDay4({Key? key}) : super(key: key);

  @override
  _MaleLossDay4State createState() => _MaleLossDay4State();
}

class _MaleLossDay4State extends State<MaleLossDay4> {
                          ...
                          children: const [
                            ...
                            Directionality(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "تفعل الطعنات ذلك تمامًا ، مما يعزز الحركة الوظيفية ",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
