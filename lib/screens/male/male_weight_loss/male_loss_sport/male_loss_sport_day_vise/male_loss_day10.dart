...
class MaleLossDay10 extends StatefulWidget {
  const MaleLossDay10({Key? key}) : super(key: key);

  @override
  _MaleLossDay10State createState() => _MaleLossDay10State();
}

class _MaleLossDay10State extends State<MaleLossDay10> {
                          ...
                          children: const [
                            ...
                            Directionality(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "تشمل تمارين الإطالة التي يمكن أن تساعد في علاج آلام الركبة الكواد ، وربلة الساق ، وأوتار.",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
