...
class MaleLossDay5 extends StatefulWidget {
  const MaleLossDay5({Key? key}) : super(key: key);

  @override
  _MaleLossDay5State createState() => _MaleLossDay5State();
}

class _MaleLossDay5State extends State<MaleLossDay5> {
                          ...
                          children: const [
                            ...
                            Directionality(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "حافظ على استقامة ذراعيك وقم بتدويرهما في دوائر للخلف. بعد 20 إلى 30 ثانية ",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
