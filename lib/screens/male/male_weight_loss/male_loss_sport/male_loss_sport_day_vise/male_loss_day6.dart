...
class MaleLossDay6 extends StatefulWidget {
  const MaleLossDay6({Key? key}) : super(key: key);

  @override
  _MaleLossDay6State createState() => _MaleLossDay6State();
}

class _MaleLossDay6State extends State<MaleLossDay6> {
                          ...
                          children: const [
                            ...
                            Directionality(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "قف على ساق واحدة مع توجيه قدمك للأمام بشكل مستقيم. ارفع السرة ",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
