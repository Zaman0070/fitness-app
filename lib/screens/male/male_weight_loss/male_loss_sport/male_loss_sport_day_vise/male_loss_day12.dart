...
class MaleLossDay12 extends StatefulWidget {
  const MaleLossDay12({Key? key}) : super(key: key);

  @override
  _MaleLossDay12State createState() => _MaleLossDay12State();
}

class _MaleLossDay12State extends State<MaleLossDay12> {
                          ...
                          children: const [
                            ...
                            Directionality(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "ستعمل نصف القرفصاء على عضلات الفخذ ، وأوتار الركبة ، والألياف ، وثني الورك  ",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
