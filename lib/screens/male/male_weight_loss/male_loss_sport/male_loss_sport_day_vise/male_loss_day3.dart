...
class MaleLossDay3 extends StatefulWidget {
  ...
  @override
  _MaleLossDay3State createState() => _MaleLossDay3State();
}

class _MaleLossDay3State extends State<MaleLossDay3> {
                          ...
                          children: const [
                            ...
                            Directionality(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "عندما يبدأ الناس في تحسين وضعيتهم ، قد يكتسبون وعيًا أكبر بجسمهم",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
