...
class MaleLossDay7 extends StatefulWidget {
  const MaleLossDay7({Key? key}) : super(key: key);

  @override
  _MaleLossDay7State createState() => _MaleLossDay7State();
}

class _MaleLossDay7State extends State<MaleLossDay7> {
                          ...
                          children: const [
                            ...
                            Directionality(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "قم بالقرفصاء حتى تصبح فخذيك أعلى قليلاً من ركبتيك ،",
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
